...
def get_training_set(data_path, train_list, crop_size=[256, 256], left_right=False, kitti=False, kitti2015=False, airsim=False, shift=0, scale_factor=1.0, subsample_factor=1.0):
  if airsim:
    return DatasetFromSessionList(train_list, crop_size, True, left_right, airsim, shift, scale_factor, subsample_factor)
  else:
